<template>
	<div class="addEdit-block" :style='{"padding":"10px 30px 30px","background":"url(http://codegen.caihongy.cn/20230228/47752d6be3a94e8892a83ec2a70c8443.png)"}' style="width: 100%;">
		...
		>
			<template >
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="化工品表名" prop="tablename">
					<el-input v-model="ruleForm.tablename" placeholder="化工品表名" clearable  :readonly="ro.tablename"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="化工品表名" prop="tablename">
					<el-input v-model="ruleForm.tablename" placeholder="化工品表名" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="化工品id" prop="goodid">
					<el-input v-model="ruleForm.goodid" placeholder="化工品id" clearable  :readonly="ro.goodid"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="化工品id" prop="goodid">
					<el-input v-model="ruleForm.goodid" placeholder="化工品id" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="化工品名称" prop="goodname">
					<el-input v-model="ruleForm.goodname" placeholder="化工品名称" clearable  :readonly="ro.goodname"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="化工品名称" prop="goodname">
					<el-input v-model="ruleForm.goodname" placeholder="化工品名称" readonly></el-input>
				</el-form-item>
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="化工品类型" prop="goodtype">
					<el-input v-model="ruleForm.goodtype" placeholder="化工品类型" clearable  :readonly="ro.goodtype"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="化工品类型" prop="goodtype">
					<el-input v-model="ruleForm.goodtype" placeholder="化工品类型" readonly></el-input>
				</el-form-item>
			</template>
	...
	data() {
		...
		return {
			...
			rules: {
				...
				goodid: [
					{ required: true, message: '化工品id不能为空', trigger: 'blur' },
				],
				goodname: [
				],
				picture: [
