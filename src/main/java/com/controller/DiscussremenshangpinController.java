...
public class DiscussremenshangpinController {
     ...
     */
    @RequestMapping("/page")
    public R page(@RequestParam Map<String, Object> params,DiscussremenshangpinEntity discussremenshangpin,
	...
	@IgnoreAuth
    @RequestMapping("/list")
    public R list(@RequestParam Map<String, Object> params,DiscussremenshangpinEntity discussremenshangpin, 
		HttpServletRequest request){
        EntityWrapper<DiscussremenshangpinEntity> ew = new EntityWrapper<DiscussremenshangpinEntity>();
    ...
    public R query(DiscussremenshangpinEntity discussremenshangpin){
		...
		return R.ok("查询化工品评论表成功").put("data", discussremenshangpinView);
    }
