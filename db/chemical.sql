...
INSERT INTO `address` VALUES (8, '2025-03-18 17:48:21', 18, '宇宙银河系地球1号', '地某', '13823888888', '是');
COMMIT;
...
CREATE TABLE `bangzhu` (
  ...
  `bangzhuhuida` longtext NOT NULL COMMENT '帮助回答',
  `fabushijian` date DEFAULT NULL COMMENT '发布时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=69 DEFAULT CHARSET=utf8mb3 COMMENT='帮助';
...
CREATE TABLE `cart` (
  `id` bigint NOT NULL AUTO_INCREMENT COMMENT '主键',
  `addtime` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `tablename` varchar(200) DEFAULT 'remenshangpin' COMMENT '化工品表名',
  `userid` bigint NOT NULL COMMENT '用户id',
  `goodid` bigint NOT NULL COMMENT '化工品id',
  `goodname` varchar(200) DEFAULT NULL COMMENT '化工品名称',
  `picture` longtext COMMENT '图片',
  `buynumber` int NOT NULL COMMENT '购买数量',
  `price` float DEFAULT NULL COMMENT '单价',
  `discountprice` float DEFAULT NULL COMMENT '会员价',
  `zhanghao` varchar(200) DEFAULT NULL COMMENT '商户名称',
  `goodtype` varchar(200) DEFAULT NULL COMMENT '化工品类型',
  PRIMARY KEY (`id`)
...
CREATE TABLE `chat` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1681552546615 DEFAULT CHARSET=utf8mb3 COMMENT='联系我们';
...
INSERT INTO `chat` VALUES (1681552546614, '2025-03-18 17:55:46', 1, 18, NULL, '主人，我是您的智能助手小搏，请问有什么可以帮您！', NULL);
COMMIT;
...
CREATE TABLE `chathelper` (
  ...
  `reply` longtext COMMENT '回复',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=89 DEFAULT CHARSET=utf8mb3 COMMENT='聊天助手表';
...
CREATE TABLE `discussremenshangpin` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COMMENT='化工品评论表';
...
CREATE TABLE `messages` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=159 DEFAULT CHARSET=utf8mb3 COMMENT='留言交流';
...
CREATE TABLE `news` (
  ...
  `content` longtext NOT NULL COMMENT '内容',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=139 DEFAULT CHARSET=utf8mb3 COMMENT='商城资讯';
...
CREATE TABLE `orders` (
  ...
  `goodid` bigint NOT NULL COMMENT '化工品id',
  `goodname` varchar(200) DEFAULT NULL COMMENT '化工品名称',
  `picture` longtext COMMENT '化工品图片',
  `buynumber` int NOT NULL COMMENT '购买数量',
...
CREATE TABLE `remenshangpin` (
  `id` bigint NOT NULL AUTO_INCREMENT COMMENT '主键',
  `addtime` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `shangpinmingcheng` varchar(200) NOT NULL COMMENT '化工品名称',
  `shangpinfenlei` varchar(200) NOT NULL COMMENT '化工品分类',
  ...
  `shangpinxiangqing` longtext COMMENT '化工品详情',
  `onelimittimes` int DEFAULT NULL COMMENT '单限',
  `alllimittimes` int DEFAULT NULL COMMENT '库存',
  `clicktime` datetime DEFAULT NULL COMMENT '最近点击时间',
  `price` float NOT NULL COMMENT '价格',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=49 DEFAULT CHARSET=utf8mb3 COMMENT='化工品';

-- ----------------------------
-- Records of remenshangpin
-- ----------------------------
BEGIN;
INSERT INTO `remenshangpin` VALUES (41, '2025-03-18 17:48:20', '化工品名称1', '化工品分类1', 'upload/1742311572076.webp', '品牌1', '账号1', '商家姓名1', '2025-03-18', '<p>化工品详情1</p>', 1, 99, '2025-03-18 23:26:03', 99.9);
INSERT INTO `remenshangpin` VALUES (42, '2025-03-18 17:48:20', '化工品名称2', '化工品分类2', 'upload/1742311583321.webp', '品牌2', '账号2', '商家姓名2', '2025-03-18', '<p>化工品详情2</p>', 2, 99, '2025-03-18 23:26:16', 99.9);
INSERT INTO `remenshangpin` VALUES (43, '2025-03-18 17:48:20', '化工品名称3', '化工品分类3', 'upload/1742311595161.webp', '品牌3', '账号3', '商家姓名3', '2025-03-18', '<p>化工品详情3</p>', 3, 99, '2025-03-18 23:26:26', 99.9);
INSERT INTO `remenshangpin` VALUES (44, '2025-03-18 17:48:20', '化工品名称4', '化工品分类4', 'upload/1742311608099.webp', '品牌4', '账号4', '商家姓名4', '2025-03-18', '<p>化工品详情4</p>', 4, 99, '2025-03-18 23:26:39', 99.9);
INSERT INTO `remenshangpin` VALUES (45, '2025-03-18 17:48:20', '化工品名称5', '化工品分类5', 'upload/1742311620630.webp', '品牌5', '账号5', '商家姓名5', '2025-03-18', '<p>化工品详情5</p>', 5, 99, '2025-03-18 23:26:52', 99.9);
INSERT INTO `remenshangpin` VALUES (46, '2025-03-18 17:48:20', '化工品名称6', '化工品分类6', 'upload/1742311634016.webp', '品牌6', '账号6', '商家姓名6', '2025-03-18', '<p>化工品详情6</p>', 6, 99, '2025-03-18 23:27:03', 99.9);
INSERT INTO `remenshangpin` VALUES (47, '2025-03-18 17:48:20', '化工品名称7', '化工品分类7', 'upload/1742311649517.webp', '品牌7', '账号7', '商家姓名7', '2025-03-18', '<p>化工品详情7</p>', 7, 99, '2025-03-18 23:27:17', 99.9);
INSERT INTO `remenshangpin` VALUES (48, '2025-03-18 17:48:20', '化工品名称8', '化工品分类8', 'upload/1742311660052.webp', '品牌8', '账号8', '商家姓名8', '2025-03-18', '<p>化工品详情8</p>', 8, 99, '2025-03-18 23:27:32', 99.9);
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `shangjia` VALUES (21, '2025-03-18 17:48:20', '账号1', '12345678', '商家姓名1', '男', 'upload/1742349998214.jpg', '773890001@qq.com', '13823888881', 200);
...
) ENGINE=InnoDB AUTO_INCREMENT=39 DEFAULT CHARSET=utf8mb3 COMMENT='化工品分类';
...
INSERT INTO `shangpinfenlei` VALUES (38, '2025-03-18 17:48:20', '化工品分类8');
COMMIT;
...
CREATE TABLE `storeup` (
  ...
  `addtime` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `userid` bigint NOT NULL COMMENT '用户id',
  `refid` bigint DEFAULT NULL COMMENT '化工品id',
...
-- ----------------------------
BEGIN;
INSERT INTO `token` VALUES (1, 1, 'admin', 'users', '管理员', 'ebhjubjp3oju34hqsdnfit4hduiitc31', '2025-03-18 17:52:34', '2025-03-19 11:00:15');
INSERT INTO `token` VALUES (2, 18, '1', 'yonghu', '用户', 'k1px643z4jzfb7tdy4lm1jx8n325vy8t', '2025-03-18 17:53:53', '2025-03-18 18:55:46');
COMMIT;
...
INSERT INTO `yonghu` VALUES (18, '2025-03-18 17:48:20', '1', '12345678', '姓名8', 'upload/1742349634707.jpg', '男', '773890008@qq.com', '13823888888', 200);
COMMIT;
...
CREATE TABLE `youqinglianjie` (
  ...
  `lianxidianhua` varchar(200) DEFAULT NULL COMMENT '联系电话',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=59 DEFAULT CHARSET=utf8mb3 COMMENT='友情链接';
